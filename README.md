# status [![Actions Status: test](https://github.com/fendijatmiko/bmi-calculator-python/workflows/python-app.yml/badge.svg)](https://github.com/fendijatmiko/bmi-calculator-python/actions?query=workflow%3A"test")
